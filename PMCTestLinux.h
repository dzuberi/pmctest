...
//
// (c) Copyright 2000-2021 by Agner Fog. GNU General Public License www.gnu.org/licences
//////////////////////////////////////////////////////////////////////////////
...
// Use this if you get the error: ‘gettid’ was not declared:
#ifdef SYSCALL_PROBLEM
...
static inline uint64_t Readpmc(uint64_t nPerfCtr) {
